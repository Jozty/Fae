...
type DropWhile_1<L extends T[] | string, T> = ((predicate: Predicate1<T>) => L)
  & ((predicate?: PH) => DropWhile_1<L, T>)

type DropWhile = (<L extends T[] | string, T>(predicate: Predicate1<T>, functor: L) => L)
  & (<L extends T[] | string, T>(predicate: Predicate1<T>, functor?: PH) => DropWhile_2<L, T>)
  & (<L extends T[] | string, T>(predicate: PH, functor: L) => DropWhile_1<L, T>)
  & ((predicate?: PH, functor?: PH) => DropWhile)

function _dropWhile<L extends T[] | string, T>(predicate: Predicate1<T>, functor: L) {
