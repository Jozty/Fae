...
export declare type Add_2 = (b: number) => number;
export declare type Add_1 = (a: number) => number;
export declare type Add = ((a: number, b?: PH) => Add_2) & ((a: PH, b: number) => Add_1) & ((a: number, b: number) => number);
/**
 * Adds two numbers
 *
...
export declare type And_2 = ((b: any) => boolean) & ((b?: PH) => And_2);
export declare type And_1 = ((a: any) => boolean) & ((a?: PH) => And_1);
export declare type And = ((a: any, b: any) => boolean) & ((a: any, b?: PH) => And_2) & ((a: PH, b: any) => And_1) & ((a?: PH, b?: PH) => And);
/**
...
export declare type Paths_2 = <T, R>(obj: ObjRec<T> | null) => R[];
export declare type Paths_1<T, R> = (pathsArr: Path[]) => R[];
export declare type Paths = ((pathsArr: Path[], obj?: PH) => Paths_2) & (<T, R>(pathsArr: PH, obj: ObjRec<T> | null) => Paths_1<T, R>) & (<T, R>(pathsArr: Path[], obj: ObjRec<T> | null) => R[]);
/**
...
export declare type Divide_2 = (b: number) => number;
export declare type Divide_1 = (a: number) => number;
export declare type Divide = ((a: number, b?: PH) => Divide_2) & ((a: PH, b: number) => Divide_1) & ((a: number, b: number) => number);
/**
 ...
 *      Fae.head(''); //=> ''
 */
export declare const head: <F extends string | ArrayLike<any> | Iterable<any> | Iterator<any, any, undefined>>(functor: F) => F extends import("./utils/types").FunctorWithArLk<infer U> ? U : string;
...
export declare type MapReturnType<F, T, R> = F extends T[] ? R[] : F extends Obj<T> ? Obj<R> : Func;
export declare type Map_2<T, R> = (<F extends Obj<T> | Func | T[]>(functor: F) => MapReturnType<F, T, R>) & ((functor?: PH) => Map_2<T, R>);
export declare type Map_1<F extends Obj<T> | Func | T[], T, R> = ((fn: FuncArr1<T, R>) => MapReturnType<F, T, R>) & ((fn?: PH) => Map_1<F, T, R>);
export declare type Map = (<F extends Obj<T> | Func | T[], T, R>(fn: FuncArr1<T, R>, functor: F) => MapReturnType<F, T, R>) & (<T, R>(fn: FuncArr1<T, R>, functor?: PH) => Map_2<T, R>) & (<F extends Obj<T> | Func | T[], T, R>(fn: PH, functor: F) => Map_1<F, T, R>) & ((fn?: PH, functor?: PH) => Map);
/**
...
export declare type Max_2<T extends number | string | Date> = (b: T) => T;
export declare type Max_1<T extends number | string | Date> = (a: T) => T;
export declare type _Max<T extends number | string | Date> = ((a: T, b?: PH) => Max_2<T>) & ((a: PH, b: T) => Max_1<T>) & ((a: T, b: T) => T);
export declare type Max = _Max<number> & _Max<string> & _Max<Date>;
/**
...
export declare type Mean = (list: number[]) => number;
/**
 * Returns the mean of the given list of numbers.
 */
export declare const mean: Mean;
export declare type Median = (list: number[]) => number;
/**
...
export declare type Min_2<T extends number | string | Date> = (b: T) => T;
export declare type Min_1<T extends number | string | Date> = (a: T) => T;
export declare type _Min<T extends number | string | Date> = ((a: T, b?: PH) => Min_2<T>) & ((a: PH, b: T) => Min_1<T>) & ((a: T, b: T) => T);
export declare type Min = _Min<number> & _Min<string> & _Min<Date>;
/**
 * Returns the smaller of its two arguments.
 */
export declare const min: Min;
export declare type Multiply_2 = (b: number) => number;
export declare type Multiply_1 = (a: number) => number;
export declare type Multiply = ((a: number, b?: PH) => Multiply_2) & ((a: PH, b: number) => Multiply_1) & ((a: number, b: number) => number);
/**
...
export declare type NthReturnType<F> = F extends FunctorWithArLk<infer U> ? U : string;
export declare type Nth_2 = <F extends FunctorWithArLk<any> | string>(functor: F) => NthReturnType<F>;
export declare type Nth_1<F extends FunctorWithArLk<any> | string> = (index: number) => NthReturnType<F>;
export declare type Nth = ((index: number, functor?: PH) => Nth_2) & (<F extends FunctorWithArLk<any> | string>(index: PH, functor: F) => Nth_1<F>) & (<F extends FunctorWithArLk<any> | string>(index: number, functor: F) => NthReturnType<F>);
/**
...
export declare type Or_2 = ((b: any) => boolean) & ((b?: PH) => Or_2);
export declare type Or_1 = ((a: any) => boolean) & ((a?: PH) => Or_1);
export declare type Or = ((a: any, b: any) => boolean) & ((a: any, b?: PH) => Or_2) & ((a: PH, b: any) => Or_1) & ((a?: PH, b?: PH) => Or);
/**
...
export declare type PathF_2 = <T, R>(obj: ObjRec<T> | null) => R;
export declare type PathF_1<T, R> = (ps: Path) => R;
export declare type PathF = ((ps: Path, obj?: PH) => PathF_2) & (<T, R>(ps: PH, obj: ObjRec<T> | null) => PathF_1<T, R>) & (<T, R>(ps: Path, obj: ObjRec<T> | null) => R);
/**
...
export declare type PathOr_1 = <D, P>(d: D) => D | P;
export declare type PathOr_2<D> = <P>(p: Path) => D | P;
export declare type PathOr_3<D> = <T, P>(obj: ObjRec<T> | null) => D | P;
export declare type PathOr_2_3<D> = ((p: Path, obj?: PH) => PathOr_3<D>) & (<T>(p: PH, obj: ObjRec<T> | null) => PathOr_2<D>) & (<T, P>(p: Path, obj: ObjRec<T> | null) => D | P);
export declare type PathOr_1_3 = (<D>(d: D, obj?: PH) => PathOr_3<D>) & (<T>(d: PH, obj: ObjRec<T> | null) => PathOr_1) & (<T, D, P>(d: D, obj: ObjRec<T> | null) => D | P);
export declare type PathOr_1_2<T> = (<D>(d: D, p?: PH) => PathOr_2<D>) & ((d: PH, p: Path) => PathOr_1) & (<D, P>(d: D, p: Path) => D | P);
export declare type PathOr = (<D>(d: D, p?: PH, obj?: PH) => PathOr_2_3<D>) & ((d: PH, p: Path, obj?: PH) => PathOr_1_3) & (<T>(d: PH, p: PH, obj: ObjRec<T> | null) => PathOr_1_2<T>) & (<D>(d: D, p: Path, obj?: PH) => PathOr_3<D>) & (<T, D>(d: D, p: PH, obj: ObjRec<T> | null) => PathOr_2<D>) & (<T>(d: PH, p: Path, obj: ObjRec<T> | null) => PathOr_1) & (<T, D, P>(d: D, p: Path, obj: ObjRec<T> | null) => D | P);
/**
...
export declare type Subtract_2 = (b: number) => number;
export declare type Subtract_1 = (a: number) => number;
export declare type Subtract = ((a: number, b?: PH) => Subtract_2) & ((a: PH, b: number) => Subtract_1) & ((a: number, b: number) => number);
...
export declare type When_1<T, R> = (predicate: Predicate1<T>) => T | R;
export declare type When_2<T> = <R>(func: FuncArr1<T, R>) => T | R;
export declare type When_3<T, R> = (value: T) => T | R;
export declare type When_2_3<T> = (<R>(func: FuncArr1<T, R>, value?: PH) => When_3<T, R>) & ((func: PH, value: T) => When_2<T>) & (<R>(func: FuncArr1<T, R>, value: T) => T | R);
export declare type When_1_3<T, R> = ((predicate: Predicate1<T>, value?: PH) => When_3<T, R>) & ((predicate: PH, value: T) => When_1<T, R>) & ((predicate: Predicate1<T>, value: T) => T | R);
export declare type When_1_2<T> = ((predicate: Predicate1<T>, func?: PH) => When_2<T>) & (<R>(predicate: PH, func: FuncArr1<T, R>) => When_1<T, R>) & (<R>(predicate: Predicate1<T>, func: FuncArr1<T, R>) => T | R);
export declare type When = (<T>(predicate: Predicate1<T>, func?: PH, value?: PH) => When_2_3<T>) & (<T, R>(predicate: PH, func: FuncArr1<T, R>, value?: PH) => When_1_3<T, R>) & (<T>(predicate: PH, func: PH, value: T) => When_1_2<T>) & (<T, R>(predicate: Predicate1<T>, func: FuncArr1<T, R>, value?: PH) => When_3<T, R>) & (<T>(predicate: Predicate1<T>, func: PH, value: T) => When_2<T>) & (<T, R>(predicate: PH, func: FuncArr1<T, R>, value: T) => When_1<T, R>) & (<T, R>(predicate: Predicate1<T>, func: FuncArr1<T, R>, value: T) => T | R);
/**
...
export declare type WhereAll_2<T> = (testObj: Obj<T>) => boolean;
export declare type WhereAll_1<T> = (specs: Tests<T>) => boolean;
export declare type WhereAll = (<T>(specs: Tests<T>, testObj?: PH) => WhereAll_2<T>) & (<T>(specs: PH, testObj: Obj<T>) => WhereAll_1<T>) & (<T>(specs: Tests<T>, testObj: Obj<T>) => boolean);
/**
...
export declare type WhereAny_2<T> = (testObj: Obj<T>) => boolean;
export declare type WhereAny_1<T> = (specs: Tests<T>) => boolean;
export declare type WhereAny = (<T>(specs: Tests<T>, testObj?: PH) => WhereAny_2<T>) & (<T>(specs: PH, testObj: Obj<T>) => WhereAny_1<T>) & (<T>(specs: Tests<T>, testObj: Obj<T>) => boolean);
/**
...
export declare type WhereEq_2<T> = (testObj: Obj<T>) => boolean;
export declare type WhereEq_1<T> = (spec: Obj<T>) => boolean;
export declare type WhereEq = (<T>(spec: Obj<T>, testObj: Obj<T>) => boolean) & (<T>(spec: Obj<T>, testObj?: PH) => WhereEq_2<T>) & (<T>(spec: PH, testObj: Obj<T>) => WhereEq_1<T>) & (<T>(spec: Obj<T>, testObj: Obj<T>) => boolean);
/**
...
export declare type Zip = (<T1>(list1: T1[], list2?: PH) => Zip_2<T1>) & (<T2>(list1: PH, list2: T2[]) => Zip_1<T2>) & (<T1, T2>(list1: T1[], list2: T2[]) => [
	T1,
	T2
][]);
/**
...
export declare type ZipWith_1<T1, T2> = <R>(fn: (a: T1, b: T2) => R) => R[];
export declare type ZipWith_2<T1, T2, R> = (list1: T1[]) => R[];
export declare type ZipWith_3<T1, T2, R> = (list2: T2[]) => R[];
export declare type ZipWith_2_3<T1, T2, R> = ((list1: T1[], list2?: PH) => ZipWith_3<T1, T2, R>) & (<L extends ArrayLike<T> | string, T = any>(list1: PH, list2: T2[]) => ZipWith_2<T1, T2, R>) & ((list1: T1[], list2: T2[]) => R[]);
export declare type ZipWith_1_3<T1> = (<T2, R>(fn: (a: T1, b: T2) => R, list2?: PH) => ZipWith_3<T1, T2, R>) & (<T2>(fn: PH, list2: T2[]) => ZipWith_1<T1, T2>) & (<T2, R>(fn: (a: T1, b: T2) => R, list2: T2[]) => R[]);
export declare type ZipWith_1_2<T2> = (<T1, R>(fn: (a: T1, b: T2) => R, list1?: PH) => ZipWith_2<T1, T2, R>) & (<T1>(fn: PH, list1: T1[]) => ZipWith_1<T1, T2>) & (<T1, R>(fn: (a: T1, b: T2) => R, list1: T1[]) => R[]);
export declare type ZipWith = (<T1, T2, R>(fn: (a: T1, b: T2) => R, list1?: PH, list2?: PH) => ZipWith_2_3<T1, T2, R>) & (<T1>(fn: PH, list1: T1[], list2?: PH) => ZipWith_1_3<T1>) & (<T2>(fn: PH, list1: PH, list2: T2[]) => ZipWith_1_2<T2>) & (<T1, T2, R>(fn: (a: T1, b: T2) => R, list1: T1[], list2?: PH) => ZipWith_3<T1, T2, R>) & (<T1, T2, R>(fn: (a: T1, b: T2) => R, list1: PH, list2: T2[]) => ZipWith_2<T1, T2, R>) & (<T1, T2>(fn: PH, list1: T1[], list2: T2[]) => ZipWith_1<T1, T2>) & (<T1, T2, R>(fn: (a: T1, b: T2) => R, list1: T1[], list2: T2[]) => R[]);
/**
