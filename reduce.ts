...
// @types
type Reduce_1<T, R> = (<P>(func: FuncArr2<R, P, R | ReducedTransformer<R>> | Transformer) => R)
...
type Reduce_2_3<R, P> = (<T>(acc: R, functor: FunctorWithArLk<T>) => R)
  & ((acc: R, functor?: PH) => Reduce_3<R, P>)
  & (<T>(acc: PH, functor: FunctorWithArLk<T>) => Reduce_2<T, R, P>)
  & ((acc?: PH, functor?: PH) => Reduce_2_3<R, P>)

type Reduce_1_3<R> = (<T, P>(func: FuncArr2<R, P, R | ReducedTransformer<R>> | Transformer, functor: FunctorWithArLk<T>) => R)
  & (<P>(func: FuncArr2<R, P, R | ReducedTransformer<R>> | Transformer, functor?: PH) => Reduce_3<R, P>)
  & (<T>(func: PH, functor: FunctorWithArLk<T>) => Reduce_1<T, R>)
  & ((func?: PH, functor?: PH) => Reduce_1_3<R>)

type Reduce_1_2<T> = (<R, P>(func: FuncArr2<R, P, R | ReducedTransformer<R>> | Transformer, acc: R) => R)
  & (<R, P>(func: FuncArr2<R, P, R | ReducedTransformer<R>> | Transformer, acc?: PH) => Reduce_2<T, R, P>)
  & (<R>(func: PH, acc: R) => Reduce_1<T, R>)
  & ((func?: PH, acc?: PH) => Reduce_1_2<T>)

type Reduce = (<T, R, P>(func: FuncArr2<R, P, R | ReducedTransformer<R> | ReducedTransformer<R>> | Transformer, acc: R, functor: FunctorWithArLk<T>) => R)
  & ((func?: PH, acc?: PH, functor?: PH) => Reduce)
  & (<R, P>(func: FuncArr2<R, P, R | ReducedTransformer<R>> | Transformer, acc?: PH, functor?: PH) => Reduce_2_3<R, P>)
  & (<R>(func: PH, acc: R, functor?: PH) => Reduce_1_3<R>)
  & (<T>(func: PH, acc: PH, functor: FunctorWithArLk<T>) => Reduce_1_2<T>)
  & (<R, P>(func: FuncArr2<R, P, R | ReducedTransformer<R>> | Transformer, acc: R, functor?: PH) => Reduce_3<R, P>)
  & (<T, R, P>(func: FuncArr2<R, P, R | ReducedTransformer<R>> | Transformer, acc: PH, functor: FunctorWithArLk<T>) => Reduce_2<T, R, P>)
  & (<T, R>(func: PH, acc: R, functor: FunctorWithArLk<T>) => Reduce_1<T, R>)

function _arrayReduce<T, R>(trans: Transformer, acc: R, list: ArrayLike<T>): R {
...
function _iterableReduce<T, R>(trans: Transformer, acc: R, it: Iterator<T>): R {
  let step = it.next()
  while(!step.done) {
...
function _reduce<T, R, P>(func: FuncArr2<R, P, R | ReducedTransformer<R>> | Transformer, acc: R, functor: FunctorWithArLk<T>): R {
